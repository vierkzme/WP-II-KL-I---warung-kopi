                ...
                <tbody>
                    ...
                    foreach ($kategori as $k) { ?>
                        <tr>
                            ...
                            <td><?= $k['kategori']; ?></td>
                            <td>
                                <a href="<?= base_url('menu/ubahKategori/') . $k['id_kategori']; ?>" class="badge badge-info">
                                    <i class="fas fa-edit"></i> Ubah
                                </a>
                                <a href="<?= base_url('menu/hapusKategori/') . $k['id_kategori']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $k['kategori']; ?>?');" class="badge badge-danger">
